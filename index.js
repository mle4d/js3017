const books = ['The Pillars of the Earth','	Number the Stars', 
  'The Joy Luck Club', 'The True Story of<br>the 3 Little Pigs',
  'The Remains of the Day','A Prayer for Owen Meany','A Time to Kill', 
  'Like Water for Chocolate', 'Wayside School<br>Is Falling Down', 
  ...
  'Borders of Infinity','The Second World War','We\'re Going on<br>a Bear Hunt',
  ...
  'What to Expect<br>the First Year','	Born in Shame','The General in His Labyrinth','	The Mummy',
  'The Heretic\'s Apprentice','Silent Partner','The Quincunx','Brothers in Arms',
  'London Fields','A Knight in Shining Armor','Mary Queen of Scotland<br>and The Isles',
  'A History of the World<br>in 10½ Chapters','Liar\'s Poker',
  'The History of the<br>Siege of Lisbon','Time and Again','Citizens',
  ...
  'Payment in Blood','Imago','Rama II','Shadow Games','Los caprichos<br>de Francisco<br>de Goya y Lucientes',
  'Præludier og Nocturner','Savage Thunder','Curses!','Mackenzie\'s Mountain','Five Little Monkeys<br>Jumping on the Bed',
  ...
  'Garden of Lies','Streams of Silver','Illness as Metaphor and<br>AIDS and Its Metaphors',
  'The Bristling Wood','Shabanu: Daughter<br>of the Wind',
